                        ...
                        <div className={`${styles.content} ${lang == 'en' ? styles.en : ''}`}>
                            ...
                            <div className="share">
                                ...
                                <div className="share_contaier">
                                    ...
                                    <Link href={`https://www.linkedin.com/shareArticle?url=${urllink}&title=${data.name}`}>
                                        <a target="_blank">
                                    ...
                                    <Link href={`https://twitter.com/share?url=${urllink}&text=${data.name}`}>
                                        <a target="_blank">
                                    ...
                                    <Link href={`https://api.whatsapp.com/send?phone=2${data.whatsNumer}&text=${lang == 'ar' ? 'مرحبا لدي استفسار عن' : 'Hey, I have a question about '}${data.name}`}>
                                        <a target="_blank">
                                ...
                                <div className={styles.blogsProjects}>
                                    {
                                        data.relatedBlogs && data.relatedBlogs.map(blog => (
                                            <div className="blogsProjectsListing" key={blog.id} >
                                                <BlogsCard blog={blog} listing='insideblog' lang={lang} />
                                            </div>
                                        ))
                                    }
                                </div>
