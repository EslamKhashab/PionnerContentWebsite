  ...
  useEffect(() => {
    async function loadData() {
      ...
      if (window.localStorage.getItem('NavDataListTime') != null) {
        if (new Date(window.localStorage.getItem('NavDataListTime')).getHours() + 1 < new Date().getHours()) {
          window.localStorage.removeItem('NavDataList');
          window.localStorage.removeItem('NavDataListTime');
        }
      }
      if (window.localStorage.getItem('NavDataList') != null) {
      ...
      if (window.localStorage.getItem('LogoIconTime') != null) {
        if (new Date(window.localStorage.getItem('LogoIconTime')).getHours() + 1 < new Date().getHours()) {
          window.localStorage.removeItem('LogoIcon');
          window.localStorage.removeItem('LogoIconTime');
        }
      }
      if (window.localStorage.getItem('LogoIcon') != null) {
      ...
      if (window.localStorage.getItem('contactDataTime') != null) {
        if (new Date(window.localStorage.getItem('contactDataTime')).getHours() + 1 < new Date().getHours()) {
          window.localStorage.removeItem('contactData');
          window.localStorage.removeItem('contactDataTime');
        }
      }
      if (window.localStorage.getItem('contactData') != null) {
      ...
      if (window.localStorage.getItem('socialDataTime') != null) {
        if (new Date(window.localStorage.getItem('socialDataTime')).getHours() + 1 < new Date().getHours()) {
          window.localStorage.removeItem('socialData');
          window.localStorage.removeItem('socialDataTime');
        }
      }
      if (window.localStorage.getItem('socialData') != null) {
      ...
      if (window.localStorage.getItem('footerLinksTime') != null) {
        if (new Date(window.localStorage.getItem('footerLinksTime')).getHours() + 1 < new Date().getHours()) {
          window.localStorage.removeItem('footerLinks');
          window.localStorage.removeItem('footerLinksTime');
        }
      }
      if (window.localStorage.getItem('footerLinks') != null) {
      ...
      if (window.localStorage.getItem('usFooterTime') != null) {
        if (new Date(window.localStorage.getItem('usFooterTime')).getHours() + 1 < new Date().getHours()) {
          window.localStorage.removeItem('usFooter');
          window.localStorage.removeItem('usFooterTime');
        }
      }
      if (window.localStorage.getItem('usFooter') != null) {
  ...
  useEffect(() => {
    navData && navData.map(category => {
      category.cities.map(item => {
        window.localStorage.setItem(`${item.name.replace(' ','_')}-${category.isCommercial ? 'commerial' : 'noncommerial'}`, item.id);
      })
    })
  }, [navData]);
  ...
  return (
    <div className="mybody english">
      <div className="mymain">
        ...
        <Nav burgerVisability={burgerVisability} setBurgerVisability={setBurgerVisability} contact={contact} navData={navData} social={social} whatssApp={whatssApp} logo={mylogo.siteLogo} />
      ...
      <Footer contact={contact} social={social} whatssApp={whatssApp} listfooterLinks={listfooterLinks} footerUsObj={footerUsObj} whatssApp={whatssApp} logo={mylogo.siteLogo} />
    </div>
  )
}
